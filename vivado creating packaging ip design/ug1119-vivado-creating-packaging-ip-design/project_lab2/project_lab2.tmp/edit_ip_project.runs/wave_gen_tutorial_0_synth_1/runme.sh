...
HD_PWD='c:/users/user/vivado/ug1119-vivado-creating-packaging-ip-design/ug1119-vivado-creating-packaging-ip-design/lab_1/project_lab2/project_lab2.tmp/edit_ip_project.runs/wave_gen_tutorial_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wave_gen_tutorial_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wave_gen_tutorial_0.tcl
