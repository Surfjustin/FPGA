...
HD_PWD='C:/Users/User/vivado/project_lab3/project_lab3.runs/axi_gpio_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_gpio_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_gpio_0.tcl
