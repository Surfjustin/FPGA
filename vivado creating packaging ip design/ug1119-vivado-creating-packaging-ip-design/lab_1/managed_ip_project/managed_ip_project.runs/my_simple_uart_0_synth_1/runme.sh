...
HD_PWD='C:/Users/User/vivado/ug1119-vivado-creating-packaging-ip-design/ug1119-vivado-creating-packaging-ip-design/lab_1/managed_ip_project/managed_ip_project.runs/my_simple_uart_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_simple_uart_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_simple_uart_0.tcl
