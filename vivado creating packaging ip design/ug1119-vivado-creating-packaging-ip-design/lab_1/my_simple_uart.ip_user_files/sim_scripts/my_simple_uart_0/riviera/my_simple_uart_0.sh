...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/User/vivado/ug1119-vivado-creating-packaging-ip-design/ug1119-vivado-creating-packaging-ip-design/lab_1/my_simple_uart.cache/compile_simlib/riviera"
  fi
  if [[ ($lib_map_path != "") ]]; then
