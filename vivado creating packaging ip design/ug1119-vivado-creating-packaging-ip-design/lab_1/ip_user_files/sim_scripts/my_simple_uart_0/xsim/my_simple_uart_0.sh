...
#
# Script generated by Vivado on Mon Jan 12 17:57:22 +0800 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : my_simple_uart_0.sh
...
#
# Usage        : my_simple_uart_0.sh
#                my_simple_uart_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                my_simple_uart_0.sh [-rerun]
#                my_simple_uart_0.sh [-reset_run]
#                my_simple_uart_0.sh [-clean]
#                my_simple_uart_0.sh [-reset_log]
#                my_simple_uart_0.sh [-help]
#
...
# script info
echo -e "my_simple_uart_0.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./my_simple_uart_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot my_simple_uart_0 xil_defaultlib.my_simple_uart_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim my_simple_uart_0 -key {Behavioral:sim_1:Functional:my_simple_uart_0} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb my_simple_uart_0.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./my_simple_uart_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: my_simple_uart_0.sh [-help]\n\
Usage: my_simple_uart_0.sh [-step]\n\
Usage: my_simple_uart_0.sh [-lib_map_path]\n\
Usage: my_simple_uart_0.sh [-rerun]\n\
Usage: my_simple_uart_0.sh [-reset_run]\n\
Usage: my_simple_uart_0.sh [-clean]\n\
Usage: my_simple_uart_0.sh [-reset_log]\n\
Usage: my_simple_uart_0.sh [-keep_index]\n\
Usage: my_simple_uart_0.sh [-noclean_files]\n\n\
