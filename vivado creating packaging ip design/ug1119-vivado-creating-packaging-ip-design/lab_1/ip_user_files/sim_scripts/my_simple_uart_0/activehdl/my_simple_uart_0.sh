...
#                script (type 'my_simple_uart_0.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/User/vivado/ug1119-vivado-creating-packaging-ip-design/ug1119-vivado-creating-packaging-ip-design/lab_1/managed_ip_project/managed_ip_project.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
