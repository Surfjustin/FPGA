...
HD_PWD='C:/Users/User/vivado/project_lab4/project_lab4.runs/myip_top_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log myip_top_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source myip_top_0.tcl
