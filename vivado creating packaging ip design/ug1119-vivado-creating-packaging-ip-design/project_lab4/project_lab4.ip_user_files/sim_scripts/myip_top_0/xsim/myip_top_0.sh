...
#
# Script generated by Vivado on Tue Jan 13 10:06:52 +0800 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : myip_top_0.sh
...
#
# Usage        : myip_top_0.sh
#                myip_top_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                myip_top_0.sh [-rerun]
#                myip_top_0.sh [-reset_run]
#                myip_top_0.sh [-clean]
#                myip_top_0.sh [-reset_log]
#                myip_top_0.sh [-help]
#
...
# script info
echo -e "myip_top_0.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./myip_top_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L common_v1_0 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot myip_top_0 xil_defaultlib.myip_top_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim myip_top_0 -key {Behavioral:sim_1:Functional:myip_top_0} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb myip_top_0.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./myip_top_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: myip_top_0.sh [-help]\n\
Usage: myip_top_0.sh [-step]\n\
Usage: myip_top_0.sh [-lib_map_path]\n\
Usage: myip_top_0.sh [-rerun]\n\
Usage: myip_top_0.sh [-reset_run]\n\
Usage: myip_top_0.sh [-clean]\n\
Usage: myip_top_0.sh [-reset_log]\n\
Usage: myip_top_0.sh [-keep_index]\n\
Usage: myip_top_0.sh [-noclean_files]\n\n\
