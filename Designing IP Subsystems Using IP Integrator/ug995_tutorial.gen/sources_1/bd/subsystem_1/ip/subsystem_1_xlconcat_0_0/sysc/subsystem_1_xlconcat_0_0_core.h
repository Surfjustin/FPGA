...
#ifndef _subsystem_1_xlconcat_0_0_core_h_
#define _subsystem_1_xlconcat_0_0_core_h_
...
class subsystem_1_xlconcat_0_0_core : public sc_module 
{
    public: 
       subsystem_1_xlconcat_0_0_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , In0    ( "In0" )
              , In1    ( "In1" )
              , In2    ( "In2" )
              ...
              , dout   ( "dout" )
    {
        SC_HAS_PROCESS(subsystem_1_xlconcat_0_0_core);
    ...
    virtual ~subsystem_1_xlconcat_0_0_core() = default;
