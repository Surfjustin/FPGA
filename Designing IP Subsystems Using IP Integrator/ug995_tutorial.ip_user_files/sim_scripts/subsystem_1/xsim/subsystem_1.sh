...
#
# Script generated by Vivado on Mon Jan 19 11:41:16 +0800 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : subsystem_1.sh
...
#
# Usage        : subsystem_1.sh
#                subsystem_1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                subsystem_1.sh [-rerun]
#                subsystem_1.sh [-reset_run]
#                subsystem_1.sh [-clean]
#                subsystem_1.sh [-reset_log]
#                subsystem_1.sh [-help]
#
...
# script info
echo -e "subsystem_1.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./subsystem_1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb subsystem_1.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./subsystem_1.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: subsystem_1.sh [-help]\n\
Usage: subsystem_1.sh [-step]\n\
Usage: subsystem_1.sh [-lib_map_path]\n\
Usage: subsystem_1.sh [-rerun]\n\
Usage: subsystem_1.sh [-reset_run]\n\
Usage: subsystem_1.sh [-clean]\n\
Usage: subsystem_1.sh [-reset_log]\n\
Usage: subsystem_1.sh [-keep_index]\n\
Usage: subsystem_1.sh [-noclean_files]\n\n\
