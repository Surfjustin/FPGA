...
HD_PWD='C:/Users/User/vivado/ug995_tutorial/ug995_tutorial.runs/subsystem_1_axi_interconnect_0_imp_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log subsystem_1_axi_interconnect_0_imp_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source subsystem_1_axi_interconnect_0_imp_auto_pc_0.tcl
