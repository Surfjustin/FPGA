...
HD_PWD='C:/Users/User/vivado/ug995_tutorial/ug995_tutorial.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log subsystem_1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source subsystem_1_wrapper.tcl
