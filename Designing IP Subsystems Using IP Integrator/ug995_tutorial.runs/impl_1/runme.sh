...
HD_PWD='C:/Users/User/vivado/ug995_tutorial/ug995_tutorial.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log subsystem_1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source subsystem_1_wrapper.tcl -notrace
