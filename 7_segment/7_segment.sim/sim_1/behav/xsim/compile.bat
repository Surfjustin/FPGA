...
REM
REM Generated by Vivado on Tue Dec 23 10:40:16 +0800 2025
...
echo "xvlog --incr --relax -prj Seven_segment_LED_Display_Controller_vlog.prj"
call xvlog  --incr --relax -prj Seven_segment_LED_Display_Controller_vlog.prj -log xvlog.log
